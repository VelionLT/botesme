...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'VelionLT.aternos.me:28757', // <--- REEMPLAZA ESTO POR LA IP DE TU SERVER
        port: 28757,                // Puerto predeterminado de Minecraft
        username: 'Raboot_masl',    // Nombre genérico del bot/NPC dentro del juego
